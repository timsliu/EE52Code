...
;    6/3/16   Tim Liu       Added boot segment
; local include files
...
; boot segment - code executes from here on reset

BOOT    SEGMENT  WORD   PUBLIC  'BOOT'

    MOV    DX, UMCSreg           ;UMCS register address
    MOV    AX, UMCSval           ;value to write to UMCS register
    OUT    DX, AX                ;output to register
    JMP    START                 ;jump to startup code
